...
<section class="content" role="main" id="main-content">
	...
	<article <?php post_class(); ?>>
		...
		<header class="post-header">
			...
			<h1 class="title" data-text="<?php the_title(); ?>"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'heightwind' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
		...
		<section class="article-content">
			...
			<div class="attachment">
				...
				$attachment_size = apply_filters( 'heightwind_attachment_size', 848 );
